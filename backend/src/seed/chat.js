...
const createConversations = async () => {
  // Conversation 1: Priya (learner1) ↔ Dr. Kavita (regulator1)
  const conv1 = await Conversation.create({
    participants: [SEED_IDS.learner1, SEED_IDS.regulator1],
    lastMessageAt: hoursAgo(2),
  });

  // Conversation 2: Priya (learner1) ↔ Meera (employer1)
  const conv2 = await Conversation.create({
    participants: [SEED_IDS.learner1, SEED_IDS.employer1],
    lastMessageAt: hoursAgo(5),
  });

  // Conversation 3: Dr. Kavita (regulator1) ↔ Meera (employer1)
  const conv3 = await Conversation.create({
    participants: [SEED_IDS.regulator1, SEED_IDS.employer1],
