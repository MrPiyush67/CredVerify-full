...
export const config = {
  ...
  digilocker: {
    ...
    authUrl: process.env.DIGILOCKER_AUTH_URL || 'http://localhost:6000/public/oauth2/1/authorize',
    tokenUrl: process.env.DIGILOCKER_TOKEN_URL || 'http://localhost:6000/public/oauth2/1/token',
    userInfoUrl: process.env.DIGILOCKER_USER_INFO_URL || 'http://localhost:6000/public/oauth2/1/user_info',
    filesUrl: process.env.DIGILOCKER_FILES_URL || 'http://localhost:6000/public/oauth2/1/files',
    downloadUrl: process.env.DIGILOCKER_DOWNLOAD_URL || 'http://localhost:6000/public/oauth2/1/files/download',
  },
};
