...
import { ArrowLeft, Puzzle, ShieldCheck, Upload, Link2, Clock, Info, Zap, Award, CheckCircle2, Download, Scan, Edit3, Database, Globe, FileCheck } from 'lucide-react';
...
export default function UploadMethodsGuidePage() {
  ...
  const methods = [
      ...
      steps: [
        {
          ...
          description: 'Add the Credify browser extension from Chrome Web Store or Firefox Add-ons',
          icon: Download,
        },
        {
          step: 2,
          title: 'Browse Platforms',
          description: 'Visit supported platforms like HackerRank, Coursera, NPTEL, or LinkedIn Learning',
          icon: Globe,
        },
        {
          step: 3,
          title: 'Auto-Detect Certificates',
          description: 'Extension automatically detects certificates on the page and highlights them',
          icon: Scan,
        },
        {
          step: 4,
          title: 'One-Click Import',
          description: 'Click the extension icon and import certificates directly to your Credify profile',
          icon: CheckCircle2,
        },
      ],
      features: [
      ...
      steps: [
        {
          ...
          description: 'Choose your educational institution from our verified database',
          icon: Database,
        },
        {
          step: 2,
          title: 'Upload Certificate',
          description: 'Upload your degree/diploma certificate (PDF or image format)',
          icon: Upload,
        },
        {
          step: 3,
          title: 'Fill Details',
          description: 'Enter credential details like degree name, roll number, graduation year',
          icon: Edit3,
        },
        {
          step: 4,
        ...
        },
        {
          ...
          description: 'Once approved, receive a verified badge on your credential',
          icon: Award,
        },
      ],
      features: [
    ...
    },
    {
      ...
      steps: [
        {
          ...
          description: 'Select PDF upload or QR code scan based on your certificate type',
          icon: FileCheck,
        },
        {
          step: 2,
          title: 'Upload/Scan',
          description: 'Drag & drop PDF file or use your camera to scan the QR code',
          icon: Scan,
        },
        {
          step: 3,
          title: 'Data Extraction',
          description: 'System extracts key information: title, issuer, date, and credential ID',
          icon: Database,
        },
        {
          step: 4,
        ...
        },
        {
          ...
          description: 'System validates against issuer\'s database or blockchain records',
          icon: ShieldCheck,
        },
      ],
      features: [
      ...
      difficulty: 'Easy',
      bestFor: 'Government certificates, skill training certificates, PDF certificates',
    },
    {
      id: 4,
      ...
      steps: [
        {
          ...
          description: 'Copy the public verification link from your certificate email or portal',
          icon: Globe,
        },
        {
          step: 2,
        ...
        },
        {
          ...
          description: 'Our system fetches and validates the certificate from the issuer\'s server',
          icon: Zap,
        },
        {
          step: 4,
          title: 'Credential Imported',
          description: 'Verified credential is automatically added to your profile',
          icon: CheckCircle2,
        },
      ],
      features: [
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        >
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Choose Your Upload Method</h2>
              <p className="text-gray-600">
                Credify offers four powerful methods to add and verify your credentials. Each method is designed for specific types of credentials and use cases. Select the method that best fits your needs.
              </p>
            </div>
          </div>
                  ...
                  <tr key={idx} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-700">{row.speed}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-600">{row.verification}</td>
                    <td className="px-6 py-4 text-sm text-gray-600">{row.bestUse}</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <div className={`bg-gradient-to-r ${method.gradient} px-8 py-6 text-white`}>
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white/90 text-sm mt-1">{method.description}</p>
                  </div>
        ...
        >
          <h3 className="text-2xl font-bold mb-3">Ready to Add Your Credentials?</h3>
          <p className="text-white/90 mb-6 max-w-2xl mx-auto">
            Choose the method that works best for your credentials and start building your verified professional profile today.
          </p>
          <Button
            onClick={() => navigate('/credentials/add')}
