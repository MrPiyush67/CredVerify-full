...
import { GraduationCap, Building2, MapPin, Briefcase, Mail } from 'lucide-react';
              ...
              <CardContent className="flex-1 flex flex-col">
                ...
                {role === 'learner' && (
                  <div className="space-y-3 flex-1">
                    {item.bio && (
                      <p className="text-xs text-muted-foreground italic line-clamp-2">"{item.bio}"</p>
                    )}
                ...
                {role === 'regulator' && (
                  <div className="space-y-3 flex-1">
                    ...
                    {(item.verifiedCount > 0 || item.rejectedCount > 0) && (
                      <div className="flex gap-2">
                        <Badge variant="success" className="text-xs">✓ {item.verifiedCount || 0} verified</Badge>
                        <Badge variant="secondary" className="text-xs">✗ {item.rejectedCount || 0} rejected</Badge>
                      </div>
                    )}
                  </div>
                )}
                ...
                {role === 'employer' && (
                  <div className="space-y-3 flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 items-center">
                      ...
                      {item.companySize && (
                        <Badge variant="secondary" className="text-xs">{item.companySize} employees</Badge>
                      )}
                    </div>
                ...
                <div className="flex justify-end">
                  <Button onClick={onViewProfile} size="sm" variant="outline" className="text-xs">
                    View Profile
                  </Button>
                </div>
              </CardContent>
