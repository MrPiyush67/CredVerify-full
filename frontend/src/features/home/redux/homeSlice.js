...
export const fetchDashboardStats = createAsyncThunk(
  ...
  async (role, { rejectWithValue }) => {
    try {
      ...
      logger.error('Failed to fetch dashboard stats', { role, error: error.message });
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(fetchUsers.fulfilled, (state, action) => {
        ...
        const rawData = action.payload.data || action.payload.users || action.payload;
    ...
    builder
      ...
      .addCase(fetchAdmins.fulfilled, (state, action) => {
        ...
        // Handle backend API response format and flatten nested user data
        const rawData = action.payload.data || action.payload.admins || action.payload;
    ...
    builder
      ...
      .addCase(fetchEmployers.fulfilled, (state, action) => {
        ...
        // Handle backend API response format and flatten nested user data
        const rawData = action.payload.data || action.payload.employers || action.payload;
    ...
    builder
      ...
      .addCase(fetchMyJobs.fulfilled, (state, action) => {
        ...
        state.myJobs.data = action.payload.data || action.payload.jobs || action.payload;
        state.myJobs.error = null;
      })
    ...
    builder
      ...
      .addCase(fetchMyApplications.fulfilled, (state, action) => {
        ...
        // Handle backend API response format: { success: true, data: [...] }
        state.myApplications.data = action.payload.data || action.payload.applications || action.payload;
        state.myApplications.error = null;
      })
    ...
    builder
      ...
      .addCase(fetchCredentialHistory.fulfilled, (state, action) => {
        ...
        // Handle backend API response format: { success: true, data: [...] }
        state.credentialHistory.data = action.payload.data || action.payload.credentials || action.payload;
        state.credentialHistory.error = null;
      })
