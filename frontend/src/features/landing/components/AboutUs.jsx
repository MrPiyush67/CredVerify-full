...
import { Plus, Target, WandSparkles, Zap } from 'lucide-react';
...
const AboutUs = () => {
  ...
  return (
    <section className="lg:py-20 sm:py-16 py-8" id='about'>
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-4">
              {aboutusData.map((item, index) => (
                ...
                >
                  ...
                  <span
                    className={'text-4xl font-normal font-instrument-serif'}
                  >
                    {item.title}
                  </span>
                </div>
