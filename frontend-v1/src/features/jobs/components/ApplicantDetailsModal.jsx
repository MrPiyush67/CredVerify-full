          ...
          <div className="flex items-center justify-between p-6 border-b bg-muted/30">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                {details?.application && (
                  <Badge
                    className={`mt-1 ${getStatusColor(details.application.status)}`}
                  >
            ...
            {loading ? (
              ...
              <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <p className="font-medium">
                            {formatDate(details.application?.appliedAt)}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                {details.profile?.skills &&
                  details.profile.skills.length > 0 && (
                    <Card>
                      <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                ...
                {details.profile?.experience &&
                  details.profile.experience.length > 0 && (
                    <Card>
                      <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                ...
                {details.verifiedCredentials &&
                  details.verifiedCredentials.length > 0 && (
                    <Card>
                      <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                          <Award className="h-5 w-5" />
            ...
            <div className="p-6 border-t bg-muted/30 flex items-center justify-between">
              ...
              <div className="flex gap-3">
                <Button
                  ...
                  disabled={
                    updating || details.application.status === 'rejected'
                  }
                  variant="outline"
                ...
                <Button
                  ...
                  disabled={
                    updating || details.application.status === 'reviewed'
                  }
                  variant="outline"
                ...
                <Button
                  ...
                  disabled={
                    updating || details.application.status === 'shortlisted'
                  }
                  className="gap-2"
                >
