...
export const getMyCredentials = async (filters = {}) => {
  try {
    ...
    const response = await axiosClient.get(ENDPOINTS.CREDENTIALS.LIST, {
      params: filters,
    });
...
export const getCredentialById = async (credentialId) => {
  try {
    ...
    const response = await axiosClient.get(
      ENDPOINTS.CREDENTIALS.GET(credentialId),
    );
...
export const updateCredential = async (credentialId, updates) => {
  try {
    ...
    const response = await axiosClient.patch(
      ENDPOINTS.CREDENTIALS.UPDATE(credentialId),
      updates,
    );
...
export const deleteCredential = async (credentialId) => {
  try {
    ...
    const response = await axiosClient.delete(
      ENDPOINTS.CREDENTIALS.DELETE(credentialId),
    );
...
export const requestVerification = async (credentialId) => {
  try {
    ...
    const response = await axiosClient.post(
      ENDPOINTS.CREDENTIALS.REQUEST_VERIFICATION(credentialId),
    );
...
export const getVerifiedCredentials = async () => {
  try {
    ...
    logger.error('Failed to fetch verified credentials', {
      error: error.message,
    });
    throw error;
  }
