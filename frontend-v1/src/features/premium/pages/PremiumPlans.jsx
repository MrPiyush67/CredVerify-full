  ...
  return (
    <div className="min-h-screen py-12 px-4 bg-background">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div
                className={`p-3 rounded-xl bg-gradient-to-br ${plans.go.color}`}
              >
            ...
            <ul className="space-y-4 mb-8">
              {plans.go.features.map((feature, index) => (
                ...
                >
                  <div
                    className={`flex-shrink-0 w-5 h-5 rounded-full ${feature.real ? 'bg-[hsl(152,68%,48%)]' : 'bg-[hsl(180,72%,24%)]'} flex items-center justify-center mt-0.5`}
                  >
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6 mt-2">
              <div
                className={`p-3 rounded-xl bg-gradient-to-br ${plans.plus.color}`}
              >
            ...
            <ul className="space-y-4 mb-8">
              {plans.plus.features.map((feature, index) => (
                ...
                >
                  <div
                    className={`flex-shrink-0 w-5 h-5 rounded-full ${feature.real ? 'bg-[hsl(152,68%,48%)]' : 'bg-[hsl(186,57%,35%)]'} flex items-center justify-center mt-0.5`}
                  >
                    <Check className="w-3 h-3 text-white" />
                  </div>
                  <div className="flex-1">
        ...
        >
          <p>
            All plans include access to core platform features. Cancel anytime.
          </p>
        </motion.div>
      </div>
    </div>
